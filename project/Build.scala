...
object Build extends sbt.Build {
  ...
  lazy val pomXml = (<url>https://github.com/hustnn/Chana-Learning-step-by-step</url>
      <licenses>
        <license>
      ...
      <scm>
        <url>git@github.com:hustnn/Chana-Learning-step-by-step.git</url>
        <connection>scm:git:git@github.com:hustnn/Chana-Learning-step-by-step.git</connection>
      </scm>)
